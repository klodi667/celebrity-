...
sudo ip addr add 111.221.1.206/24 dev br0
sudo ip addr add 111.221.1.254/24 dev br0
sudo ip addr add 114.134.92.85/24 dev br0
sudo ip addr add 114.134.95.77/24 dev br0
sudo ip addr add 138.197.130.231/24 dev br0
sudo ip addr add 203.112.75.49/24 dev br0
sudo ip addr add 203.112.77.245/24 dev br0
sudo ip addr add 27.147.143.166/24 dev br0
sudo ip addr add 61.247.179.37/24 dev br0
sudo ip addr add 61.247.181.21/24 dev br0
sudo ip addr add 61.247.182.209/24 dev br0
sudo ip addr add 61.247.182.33/24 dev br0
sudo ip addr add 61.247.183.93/24 dev br0
sudo ip addr add 61.247.186.201/24 dev br0
sudo ip addr add 61.247.188.57/24 dev br0
sudo ip addr add 61.247.190.153/24 dev br0
sudo ip addr add 61.247.190.181/24 dev br0
sudo ip addr add 61.247.190.21/24 dev br0
sudo ip addr
